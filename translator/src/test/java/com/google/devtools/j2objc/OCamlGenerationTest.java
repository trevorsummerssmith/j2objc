...
import com.google.devtools.j2objc.gen.ocaml.OCamlStatementGenerator;
 ...
 * @author Tom Ball
 */
public class OCamlGenerationTest extends TestCase {
  ...
  static {
    ...
    ClassLoader cl = OCamlGenerationTest.class.getClassLoader();
  ...
  protected static List<String> getComGoogleDevtoolsJ2objcPath() {
    ClassLoader loader = OCamlGenerationTest.class.getClassLoader();
    List<String> classpath = Lists.newArrayList();

    if (loader instanceof URLClassLoader) {
      URL[] urls = ((URLClassLoader) OCamlGenerationTest.class.getClassLoader()).getURLs();
  ...
  protected String generateStatement(Statement statement) {
    return OCamlStatementGenerator.generate(statement, SourceBuilder.BEGINNING_OF_FILE).trim();
  }
