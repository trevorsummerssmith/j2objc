...
/**
 * Returns an OCaml equivalent of a Java AST node.
 *
 * @author Trevor Summers Smith
 * @author Tom Ball
 */
public class OCamlStatementGenerator extends UnitTreeVisitor {

  private final SourceBuilder buffer;

  public static String generate(TreeNode node, int currentLine) {
    OCamlStatementGenerator generator = new OCamlStatementGenerator(node, currentLine);
    if (node == null) {
  ...
  private OCamlStatementGenerator(TreeNode node, int currentLine) {
